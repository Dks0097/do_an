...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Thêm chỗ đặt</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Thêm chỗ đặt</li>
							</ol>
						</nav>
					</div>
    ...
    <form method="POST" action="{{ route('store.roomlist') }}" class="row g-3">
     ...
     <input type="date" name="check_in" class="form-control" id="check_in"  >
        ...
        <div class="col-md-4">
            <label for="input3" class="form-label">Phòng</label>
            ...
            <div class="mt-2">
                <label for="">khả dụng <span class="text-success availability"></span> </label>
            </div>
        ...
        <div class="col-md-4">
            <label for="input4" class="form-label">Số lượng người</label>
     ...
     <h3 class="mt-3 mb-5 text-center">thông tin khách hàng </h3>
        ...
        <div class="col-md-4">
            <label for="input5" class="form-label">Tên</label>
        ...
        <div class="col-md-4">
            <label for="input5" class="form-label">Thành Phố</label>
            <input type="text" name="country" class="form-control" value="{{ old('country') }}"  >
        </div>

        <div class="col-md-4">
            <label for="input5" class="form-label">Mã bưu chính</label>
            <input type="text" name="zip_code" class="form-control" value="{{ old('zip_code') }}"  >
        </div>

        <div class="col-md-4">
            <label for="input5" class="form-label">Tình trạng</label>
