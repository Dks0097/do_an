...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Thêm bài đăng</div>
					<div class="ps-3">
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <form  class="row g-3" action="{{ route('store.blog.post') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <label for="input1" class="form-label">Tiêu đề bài đăng</label>
                    ...
                    <div class="col-md-12">
                        <label for="input11" class="form-label">Mô tả bài đăng</label>
                        <textarea name="long_descp" class="form-control" id="myeditorinstance" ></textarea>
                    </div>

                    <div class="col-md-6">
                        <label for="input1" class="form-label">Ảnh bài đăng</label>
