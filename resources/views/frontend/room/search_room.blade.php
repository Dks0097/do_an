        ...
        <div class="row pt-45">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="room-card">
                    ...
                    <div class="content">
                        <h3><a href="{{ route('search_room_details',$item->id.'?check_in='.old('check_in').'&check_out='.old('check_out').'&persion='.old('persion'))}}">{{ $item['type']['name'] }}</a></h3>
                        <ul>
           ...
           <h3 class="text-center text-danger">Rất tiếc, không có phòng trống theo sở thích tìm kiếm của bạn</h3>
